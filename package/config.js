if (ConfigObj) {
    ...
    // 正式环境接口
    // ConfigObj.zdid = '40CE50-AEE4-4A9348'; //掌上彩应用宝   
    // console.log(ConfigObj.zdid)
    // ConfigObj.zdid = ''; //   
    // ConfigObj.zdid = '1B5D8A-D5C9-90298B'; //测试  
    // ConfigObj.zdid = '905CDE-29C8-9DBC02'; //  ios豪中彩渠道
    // ConfigObj.zdid = 'FCC476-D0C2-DCE8AF'; // 应用宝
    ConfigObj.zdid = 'FBE0A0-0783-9011CE'; //酷派
    // ConfigObj.zdid = 'C645CE-7FF3-582628'; //酷派豪中彩
    // ConfigObj.zdid = 'D3663A-7330-63B9DC'; // 豪中彩vivo
    // ConfigObj.zdid = '10D4E6-A17E-97D364';  //资讯版本
    // ConfigObj.zdid = '0F267B-2DF3-D646F5';
    // console.log(ConfigObj.zdid) D3663A-7330-63B9DC  豪中彩vivo
    // ConfigObj.appkey = 'D0589543-7652-B107-69CA-9F63707ADD09'; //实时赛事比分分析
    ConfigObj.appkey = 'EF0D1335-20C7-1993-F970-A69DEE4A253F'; //天天中彩
    // ConfigObj.appkey = 'B6017483-9096-6D4B-D1F7-0E62E6A07650'; // 竞彩大师在线
    ...
    // ConfigObj.appkey = '717CDDF7-C01E-D685-8FB3-9C7FE61DC2D8'; //世界杯比分预测大师
    // ConfigObj.appkey = '1FD97BDB-0BFF-C4A3-947B-9746D42BF2B0'; //掌上彩
    // ConfigObj.appkey = '95C113C9-CA1B-1310-7398-03AF14768C0E'; //快乐透
    // ConfigObj.localSite = 'http://cptest.xxyya.cn:9527/api';  //测试环境 
    // 
    ConfigObj.localSite = 'https://a.xxyya.cn/api';
    // ConfigObj.localSite = 'http://test.xyjcdss.cn:8265/api';
    // ConfigObj.localSite = 'http://test.wasg2.cn:8269/api';
...
//  ConfigObj.appDLUrl = 'http://caipiao.91zbl.cn:8080/System/DownLoad/page?sharefrom=app'; // 下载页
    ...
    ConfigObj.fastK3Api = {
        ...
        'jsk3':{
            scheme:'?version=1&m=lottery.jsk3.index',
            chart:'?version=1&m=Lottery.jsk3.getChartData'
        }
    };
    ...
    if (ConfigObj.platForm === 'android' && typeof android_obj !== 'undefined') {
        ...
        ConfigObj.zdid = '905CDE-29C8-9DBC02';    //ios渠道号
    }   
}
